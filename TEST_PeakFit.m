...
% N100
indList_N100_Baseline = 1:3;
onTime_N100_Baseline = 20;

indList_N100_Deviant = 1:4;

% CHECK STUFF
Path1 ='data\\SEDs\\Scherg N1\\Time';
Path2 ='data\\SEDs\\Scherg N1\\CondDeviant'; % Change that
e =eN100; % Change that
onTime = onTime_N100_Baseline;
indList = indList_N100_Deviant;
name = 'dA_N100_Deviant'; % Check this!!
component = 'N100 deviant';
