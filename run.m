...
listOption = {'Create new sim', 'Load sim', 'Display conductivities options', 'Display electrodes options', 'Display atlases', 'Display ERP empirical data'};
...
while ~done_sim
    listOption = {'Select headmesh','Choose conductivities', 'Choose sensors', 'Create modules',...
        ...
        'Generate leadfield', 'Dipoles 2 leadfield', 'Create EEG data for an electrode',...
        ...
        'Display area activity', 'Display leadfield'};
    prompt = 'Select option';
    mode = 'single';
    option = getOption(listOption,prompt,mode);
    if option.ok
        switch option.ind
            ...
            case 12
                % Generate leadfield for a selection of dipoles
                fprintf('Dipoles 2 leadfield\n');
