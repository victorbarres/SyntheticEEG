...
Step7:
    ...
    A module represents a set of brainregions.
...
Step8:
    ...
    Note: Single dipole should be used with caution...Approximation only valid for brain regions where curvature is negligeable.
